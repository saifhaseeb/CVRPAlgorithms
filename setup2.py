...
heuristicLaunch = Button(root, text="Run heuristic algorithm", command=heuristic)
metaHeuristicLaunch = Button(root, text="Run metaheuristic algorithm", command=metaheuristic)
exactSolverLaunch = Button(root, text="Run exact solver algorithm", command=exact)
